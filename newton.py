...
def plot(screen, winsize, thickness, f, scale):
    ...
    for i in range (0, winsize):
        ...
        if i != 0:
            pygame.draw.aaline(screen, color,prev_pos,pos, thickness)
        prev_pos = pos
...
def drawAxis(winsize, screen, axis_thickness):
    ...
    pygame.draw.aaline(screen, (255, 255, 255),p[0],p[1], axis_thickness)
    pygame.draw.aaline(screen, (255, 255, 255),p[2],p[3], axis_thickness)
